import DifferentialGeometricAspectsStatisticalManifoldsFoundationCanonicalLaneLean.ReviewerBridge
...
def sourceRepository : String :=
  "differential-geometric-aspects-statistical-manifolds-foundation-canonical-lane-lean"

def sourceDescription : String :=
  "Differential Geometric Aspects of Statistical Manifolds Foundation"

def sourceTheoremBoundary : String :=
  "StatManifolds boundary"
...
def formalizationCertificateSourceConjectureClosureClaimed : Bool :=
  false
...
def sourceTheoremStatement : TheoremStatement :=
  { sourceKey := sourceRepository,
    ...
    carriedRemainder :=
      "classical source boundary carried by formalizationCertificateTheoremBoundaryOpen and sourceTheoremBoundary"
  }
